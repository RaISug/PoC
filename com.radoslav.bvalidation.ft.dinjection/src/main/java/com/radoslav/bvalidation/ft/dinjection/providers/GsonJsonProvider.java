...
public class GsonJsonProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
  ...
  private Gson getGson() {
    return new GsonBuilder().registerTypeAdapter(Date.class, new JsonDeserializer<Date>() {
      ...
      public Date deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context) throws JsonParseException {
        try {
          return jsonElement == null ? null : new SimpleDateFormat("yyyy.MM.dd").parse(jsonElement.getAsString());
  ...
  public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations, MediaType mediaType,
    ...
    try {
      ...
      System.out.println("Failed to parse request body. Null value will be returned.");
      return null;
    }
  }
